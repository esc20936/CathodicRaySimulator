...
def cambiarModo():
    ...
    if sinusoidal:
        LabelModo.config(text="Modo: sinusoidal")
        ...
        LabelModo.config(text="Modo: normal")
...
vxLabel = tk.Label(root, text = "Voltaje X") 
...
vyLabel = tk.Label(root, text = "Voltaje Y") 
...
va = tk.Label(root, text = "N. Voltaje Aceleracion") 
...
buttonCambiar = tk.Button(text='Cambiar modo', command=cambiarModo)
canvas1.create_window(200, 10, window=buttonCambiar)

LabelModo = tk.Label(root, text = "Modo: Sinusoidal") 
